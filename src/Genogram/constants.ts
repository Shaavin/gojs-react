...
export const ADORNMENT_STROKE_WIDTH = STROKE_WIDTH + 1;
export const CORNER_ROUNDNESS = 12;
export const IMAGE_TOP_MARGIN = 20;
export const MAIN_SHAPE_NAME = "mainShape";
export const IMAGE_DIAMETER = 40;

export const theme = {
  colors: {
    femaleBadgeBackground: "#FFCBEA",
    maleBadgeBackground: "#A2DAFF",
    otherBadgeBackground: "#A8FFA2",
    femaleBadgeText: "#7A005E",
    maleBadgeText: "#001C76",
    otherBadgeText: "#027600",
